...
// Create sale property schema
const createSalePropertySchema = Joi.object({
  ...
  propertyType: Joi.string()
    ...
    .required()
    .messages({
      "any.only": "Property type must be one of: apartment, house, duplex, bungalow, flat, room, studio, land, commercial",
...
// Update sale property schema
const updateSalePropertySchema = Joi.object({
...
// Sale inquiry schema
const createSaleInquirySchema = Joi.object({
...
const respondToSaleInquirySchema = Joi.object({
...
const searchSalePropertiesSchema = Joi.object({
  // Search query
...
const verifySalePropertySchema = Joi.object({
