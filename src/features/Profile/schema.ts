...
export const createOwnerProfileSchema = Joi.object({
...
export const createBrokerProfileSchema = Joi.object({
...
export const updateBrokerProfileSchema = Joi.object({
  agencyCompanyName: Joi.string().max(100).optional().allow('', null),
  companyYearsOfExistence: Joi.string().optional().allow('', null),
  operatingLocations: Joi.array().items(Joi.string()).optional(),
  companySize: Joi.string().optional().allow('', null),
...
export const createSeekerPreferenceSchema = Joi.object({
...
export const updateSeekerPreferenceSchema = Joi.object({
  preferredPropertyType: Joi.string()
    .valid('apartment', 'house', 'condo', 'townhouse', 'studio', 'any')
    .optional(),
  preferredLocation: Joi.string().max(100).optional(),
...
export const updateUserActivitySchema = Joi.object({
...
export const verificationDocumentsSchema = Joi.object({
  documents: Joi.array()
    .items(
      Joi.object({
        type: Joi.string()
